...
export const LANDSCAPE_MATERIALS: PlanLandscapeMaterial[] = [
  { id: "tree-canopy", name: "큰 나무", shortLabel: "큰 나무", category: "planting", realWidthMeters: 5, realHeightMeters: 5, planAssetUrl: null, modelAssetUrl: null, color: "#397b4a", shape: "circle" },
  { id: "pine", name: "작은 나무", shortLabel: "작은 나무", category: "planting", realWidthMeters: 3, realHeightMeters: 3, planAssetUrl: null, modelAssetUrl: null, color: "#246342", shape: "conifer" },
  ...
  { id: "flower", name: "꽃", shortLabel: "꽃", category: "planting", realWidthMeters: 0.6, realHeightMeters: 0.6, planAssetUrl: null, modelAssetUrl: null, color: "#b36b82", shape: "cluster" },
  ...
  { id: "dirt-path", name: "산책로", shortLabel: "산책로", category: "paving", realWidthMeters: 3, realHeightMeters: 1.5, planAssetUrl: null, modelAssetUrl: null, color: "#a7875e", shape: "line" },
  ...
  { id: "rock", name: "돌", shortLabel: "돌", category: "scenery", realWidthMeters: 1, realHeightMeters: 0.8, planAssetUrl: null, modelAssetUrl: null, color: "#777b76", shape: "organic" },
